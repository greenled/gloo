	...
	public void test_delete() {
		running(testServer(3333, fakeApplication(inMemoryDatabase())), HTMLUNIT, new Callback<TestBrowser>() {
			public void invoke(TestBrowser browser) {
				...
				browser.$("#content").text("Probando delete");
				browser.$("#save").click();
				
				String key = browser.title();
				browser.goTo("http://localhost:3333/delete/" + key);
				
				assertThat (browser.pageSource()).isEqualTo("Se ha eliminado " + key);
			}
		});
	}
